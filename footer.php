...
<footer class="mt-2 shadow">
    <div class="container footer-lists mb-4">
        <div class="footer-lists-item">
            <p>Services</p>
            <ul>
                <a href="#"><li>Road Transportation</li></a>
                <a href="#"><li>Pickups/Way-billing</li></a>
            </ul>
        </div>

        <div class="footer-lists-item">
            <p class="capitalize  p-1">Links</p>
            <ul>
                <a href="#"><li>Book A Ticket</li></a>
        ...
        <div class="footer-lists-item">
            ...
            <ul>
                ...
                <a href="#"><li>Internship Program</li></a>
                <a href="#"><li>Learning Academy</li></a>
                <a href="#"><li>Jakebook Api</li></a>
            </ul>
        </div>
    ...
    <div class="connect">
        <div class="socials">
            <p class="shadow rounded">Stay Connected</p>
            <ul>
                <!-- facebook -->
        ...
        <div class="newsletter">
            <form action="" class="m-auto">
                ...
                <input type="email" name="newsletter-email" id="newsletter-email" placeholder="Type In Your Email"><br>
    ...
    <div class="container">
        <p class="center"><small>Copyright © 2020 Jakebook. All rights reserved.</small></p>
    </div>
</footer>
